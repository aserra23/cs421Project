...
https://nlp.stanford.edu/software/stanford-parser-full-2018-02-27.zip
				...
				***
We don't know if nltk differentiates between versions but if it does then rename the file as stanford-parser-full-2018-02-27/ after it is unzip if you have a newer version. The same thing could be done with an older version.
